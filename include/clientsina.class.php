...
{ 
    ...
    { 
        $this->oauth = new cls_oauthsina($akey , $skey , $accecss_token , $accecss_token_secret ); 
    } 
    ...
    { 
        return $this->oauth->get('http://api.t.sina.com.cn/statuses/public_timeline.json?count='.$count.'&base_app='.$base_app); 
    } 
    ...
    { 
        return $this->oauth->get('http://api.t.sina.com.cn/statuses/home_timeline.json?count='.$count); 
    } 
