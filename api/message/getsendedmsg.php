...
$result = $cls_message->get_sended($uid, $page, $pagesize,  $ord, $appname);
if($result)
{
    ...
    array_unique($fuid_arr);
    array_unique($msgid_arr);
    $cls_user = new cls_user();
    $userinfo = $cls_user->get_userinfo_list($fuid_arr);
    unset($fuid_arr);
    ...
    foreach($result as $key=>$val)
    {
        ...
        $result[$key]['receiver'] = isset($receiver_info[$val['fuid']]) ? $receiver_info[$val['fuid']] : ''; 
